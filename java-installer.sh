...
# java-installer.sh - Redhat Java Installer (Oracle JDK)
# Copyright 2017 Omar Eissa
...
function display_help {
   ...
   echo "      Use this option with caution, as yum may remove other packages"
   echo "      through dependencies. Before yum start removing OpenJDK from"
...
JDK_LOCATION=/opt/$JDK_VERSION
#mkdir -p /usr/local/java
tar -xf $JDK_ARCHIVE -C /opt/
echo "OK"
